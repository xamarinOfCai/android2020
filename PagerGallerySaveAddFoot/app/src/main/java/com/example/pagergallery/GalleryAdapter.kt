...
class GalleryAdapter:ListAdapter<PhotoItem, MyViewHolder>(DIFFCALLBACK) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        ...
        if(viewType == NORMAL_VIEW_TYPE) {
            ...
            holder = MyViewHolder(
                LayoutInflater.from(parent.context).inflate(R.layout.gallery_footer, parent, false).also {         //独占一行
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        var photeItem = getItem(position)
        with(holder.itemView){
            ...
            textViewUser.text = photeItem.photoUser
            textViewlikes.text = photeItem.photoLikes.toString()
            textViewFavorites.text = photeItem.photoFavorites.toString()
            imageView.layoutParams.height =photeItem.photoHeight
        }
